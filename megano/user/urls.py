...
from .views import register, Reset_Password, Login, logout_view, Reset_Password_Done, Reset_Password_Confirm, Reset_Password_Complete
...
urlpatterns = [
    ...
    path('recovery/e-mail/complete/', Reset_Password_Complete.as_view(), name='password_reset_complete')
]